...
<div class="module-body custom-code">
    ...
    <accordion id="main-accordion" close-others="accordion.close_others">
      ...
      <accordion-group is-open="accordion.accordions[2]">
        <accordion-heading>
          <div class="accordion-bar bar-level-0">Agree to Terms</div>
        </accordion-heading>
        <ul class="module-create-options">
          ...
          <li>
            ...
            <span class="module-create-option">
                      <switch data-ng-model="settings.popup_privacy">
          ...
          <li data-ng-show="settings.popup_privacy != 0">
            <span class="module-create-title">Terms to Agree to</span>
            <span class="module-create-option extra-long">
                      <information-search model="settings.popup_privacy_information"></information-search>
                  </span>
            <a href="#" target="_blank" class="journal-tip"></a>
          </li>
