...
class ModelDesignLayout extends Model {
	...
	public function getLayoutModules($layout_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "layout_module WHERE layout_id = '" . (int)$layout_id . "' AND `code` NOT LIKE 'journal2_%' ORDER BY position ASC, sort_order ASC");
